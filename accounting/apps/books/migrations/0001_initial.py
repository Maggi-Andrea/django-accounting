...
import accounting.apps.books.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_dued', models.DateField(blank=True, default=None, help_text='The date when the total amount should have been collected', null=True, verbose_name='Due date')),
                ('date_paid', models.DateField(blank=True, null=True)),
            ],
            options={
                'ordering': ('-number',),
            },
            bases=(accounting.libs.checks.CheckingModelMixin, accounting.apps.books.models.TotaLinesMixin, accounting.apps.books.models.TotaContributionsMixin, models.Model),
        ),
        migrations.CreateModel(
            name='BillLine',
            fields=[
